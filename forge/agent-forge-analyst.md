...
Return ONLY JSON:
{
  "plan_version": "forge.v1",
  "roles": [{"name": "", "purpose": "", "inputs": [""], "outputs": [""], "tools": {"read": false, "write": false, "edit": false, "bash": false, "glob": false, "grep": false, "task": false, "webfetch": false}, "constraints": [""]}],
